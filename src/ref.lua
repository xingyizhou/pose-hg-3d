...
-- Project directory
projectDir = paths.concat(os.getenv('HOME'),'Projects/pose-hg-3d')
...
if not ref.alreadyChecked then
    ...
    if opt.dataset == 'fusion' then
        print("# of training mpii images:", opt.idxRef['mpii'].train:size(1))
        print("# of training h36m images:", opt.idxRef['h36m'].train:size(1))
        print("# of validation mpii images:", opt.idxRef['mpii'].valid:size(1))
        print("# of validation h36m images:", opt.idxRef['h36m'].valid:size(1))
    else 
